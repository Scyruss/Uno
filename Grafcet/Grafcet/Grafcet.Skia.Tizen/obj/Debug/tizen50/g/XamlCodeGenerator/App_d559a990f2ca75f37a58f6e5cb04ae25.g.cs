...
namespace Grafcet
{
	...
	partial class App : Windows.UI.Xaml.Application
	{
				private void InitializeComponent()
		{
			...
			.GenericApply((c0 => 
			{
				// Source C:\Users\romai\source\repos\Uno\Grafcet\Grafcet\Grafcet.Shared\App.xaml (Line 1:2)
			...
			global::Grafcet.Skia.Tizen.GlobalStaticResources.Initialize();
			global::Grafcet.Skia.Tizen.GlobalStaticResources.RegisterResourceDictionariesBySourceLocal();
			global::Uno.UI.DataBinding.BindableMetadata.Provider = new global::Grafcet.Skia.Tizen.BindableMetadataProvider();
			#if __ANDROID__
			global::Uno.Helpers.DrawableHelper.Drawables = typeof(global::Grafcet.Skia.Tizen.Resource.Drawable);
			#endif
			// MergedDictionaries
			...
			// Source ..\..\..\..\..\..\..\Grafcet.Shared\App.xaml (Line 1:2)
		}
...
{
	static class App_d559a990f2ca75f37a58f6e5cb04ae25XamlApplyExtensions
	{
	}
}
